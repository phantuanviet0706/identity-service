...
import com.vietphan.identity_service.repository.InvalidatedTokenRepository;
...
public class AuthenticationService {
    ...
    private String generateToken(User user) {
        ...
        JWTClaimsSet jwtClaimsSet = new JWTClaimsSet.Builder()
                ...
                .issuer("vietphan565") //Token được issue từ ai
                .issueTime(new Date())
                .expirationTime(new Date(
                        Instant.now().plus(1, ChronoUnit.HOURS).toEpochMilli()
                )) //Xác định thời hạn của token
        ...
        // MACSigner: Thuật toán ký symmetric (Khóa ký & giải mã trùng nhau)
        try {
